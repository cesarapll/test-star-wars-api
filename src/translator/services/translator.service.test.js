...
describe('Translator Service', () => {
    ...
    const getApiPersonSpy = jest.spyOn(starWarsApiClient, "get");
    let getApiReponse = null
    let translatedObject = null;
    describe('getPersonTranslatedById', () => {
        ...
        it('should return the translated person object', async () => {
            getApiPersonSpy.mockImplementation(() => {
                return { data: getApiReponse }
            })
